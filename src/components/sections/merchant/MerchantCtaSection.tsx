...
export default function MerchantCtaSection() {
        ...
        <div className="grid lg:grid-cols-2 gap-0 min-h-80">
          ...
          >
            <h2 className="font-display text-5xl sm:text-6xl lg:text-7xl font-black text-hype-black leading-none">
              Lebih Banyak<br />
              Pelanggan.<br />
              <span className="italic">Mulai Sekarang.</span>
            </h2>
          </motion.div>
          ...
          >
            <p className="text-hype-black/70 text-base sm:text-lg mb-8 leading-relaxed max-w-sm">
              Konsultasi gratis dengan tim HYPE — kami jelaskan strategi terbaik
              untuk bisnis dan kota Anda.
            </p>
